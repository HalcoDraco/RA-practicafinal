#!/usr/bin/env python3
"""
Orchestrator node for the UPC mobile project (ROS Noetic)
====================================================================
...
• Sends "stop" string to movement node via /move_ctrl.
• Listens for **detected_color**, **arrived**.
...
class Orchestrator:
    def __init__(self):
        ...
        self.last_house = None  # To keep track of the last house visited
